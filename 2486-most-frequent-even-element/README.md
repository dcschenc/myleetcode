<h2><a href="https://leetcode.com/problems/optimal-partition-of-string/description/">2486. Most Frequent Even Element</a></h2><h3>Easy</h3><hr><p>Given an integer array <code>nums</code>, return <em>the most frequent even element</em>.</p>
