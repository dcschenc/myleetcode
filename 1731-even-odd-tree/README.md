<h2><a href="https://leetcode.com/problems/maximum-number-of-visible-points/">1731. Even Odd Tree</a></h2><h3>Medium</h3><hr><p>A binary tree is named <strong>Even-Odd</strong> if it meets the following conditions:</p>
