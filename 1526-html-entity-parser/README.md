<h2><a href="https://leetcode.com/problems/number-of-ways-to-paint-n-3-grid/">1526. HTML Entity Parser</a></h2><h3>Medium</h3><hr><p><strong>HTML entity parser</strong> is the parser that takes HTML code as input and replace all the entities of the special characters by the characters itself.</p>
