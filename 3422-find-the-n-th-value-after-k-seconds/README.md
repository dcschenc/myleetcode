<h2><a href="https://leetcode.com/problems/maximum-total-reward-using-operations-i">3422. Find the N-th Value After K Seconds</a></h2><h3>Medium</h3><hr><p>You are given two integers <code>n</code> and <code>k</code>.</p>
