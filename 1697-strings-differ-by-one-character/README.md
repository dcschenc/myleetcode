<h2><a href="https://leetcode.com/problems/bank-account-summary/">1697. Strings Differ by One Character</a></h2><h3>Medium</h3><hr><p>Given a list of strings <code>dict</code> where all the strings are of the same length.</p>
