<h2><a href="https://leetcode.com/problems/k-divisible-elements-subarrays/">2338. Minimum Consecutive Cards to Pick Up</a></h2><h3>Medium</h3><hr><p>You are given an integer array <code>cards</code> where <code>cards[i]</code> represents the <strong>value</strong> of the <code>i<sup>th</sup></code> card. A pair of cards are <strong>matching</strong> if the cards have the <strong>same</strong> value.</p>
